...
export class UserGamificationMapper {
  ...
  static toDomain(doc: UserGamificationDocument): UserGamificationEntity {
    return {
      ...
      dailyAiTokenCount: doc.dailyAiTokenCount,
      monthlyBuddyMatchCount: doc.monthlyBuddyMatchCount,
      monthlyRoomJoinCount: doc.monthlyRoomJoinCount,
  ...
  static toPersistence(
    ...
    if (data.dailyAiTokenCount !== undefined) result.dailyAiTokenCount = data.dailyAiTokenCount;
    if (data.monthlyBuddyMatchCount !== undefined) result.monthlyBuddyMatchCount = data.monthlyBuddyMatchCount;
    if (data.monthlyRoomJoinCount !== undefined) result.monthlyRoomJoinCount = data.monthlyRoomJoinCount;
