...
export const SUCCESS_MESSAGE = {
  AUTHORIZATION: {
    ACCOUNT_CREATED: 'OTP sent successfully. Please verify your email.',
...
// ─── AI Tokens (free resets monthly, premium resets daily) ───────────────────
export const FREE_MONTHLY_AI_TOKENS = 30;
